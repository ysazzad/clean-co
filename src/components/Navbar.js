        ...
        <div class="drawer drawer-end" data-theme={dark ? "dark" : "light"}>
            ...
            <div class="drawer-content flex flex-col">
                ...
                <div class="w-full navbar fixed top-0 z-50 bg-base-100 lg:px-20">
                    {pathname.includes("dashboard") && <label tabindex="0" class="btn btn-ghost lg:hidden" for="my-drawer-2">
                ...
                <ul class="menu p-4 overflow-y-auto w-80 bg-base-100">
                    ...
                    <div tabindex="0" class="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
                        ...
                        <div class="collapse-content">
                            <li><NavLink to="/about" className='rounded-lg'>Quick Book</NavLink></li>
                            <li><NavLink to="/contact" className='rounded-lg'>Pre Book</NavLink></li>
                        </div>
                    </div>
